...
function _bindToolbar() {
  ...
  // Close panel when user taps canvas
  ...
  // Mobile panel buttons delegate to existing actions
  document.getElementById('mob-btn-fit').addEventListener('click', () => {
    fitToScreen(); moreMenu.classList.add('hidden');
  });
  document.getElementById('mob-btn-save').addEventListener('click', () => {
    window.promptForge.saveSession(); moreMenu.classList.add('hidden');
  });
  document.getElementById('mob-btn-load').addEventListener('click', () => {
    window.promptForge.loadSession(); moreMenu.classList.add('hidden');
  });
  document.getElementById('mob-btn-custom').addEventListener('click', () => {
    _openCustomNodeModal(); moreMenu.classList.add('hidden');
  });
